...
*Athanasios Grigoriou et al, and Francesco Grussu*. **"Histology-informed microstructural diffusion simulations for MRI cancer characterisation—the Histo-μSim framework"**. Communications Biology 2025, 8: 1695, doi: [10.1038/s42003-025-09096-3](https://doi.org/10.1038/s42003-025-09096-3).
<div align="center">
  <img src="https://github.com/fragrussu/bodymritools/blob/main/logos/commbioshot.png" alt="CommBio" width="650" height="auto">
</div>
...
* [**getSphericalMean.py**](https://github.com/fragrussu/bodymritools/blob/main/misctools/getSphericalMean.py): a tool _**computing the spherical mean signals (average over multiple gradient directions) for a fixed b-value and diffusion time, as a NIFTI**_. Manual [here](https://github.com/fragrussu/bodymritools/blob/main/manuals/getSphericalMean.md).
* [**CreateCustomSchemeFile.py**](https://github.com/fragrussu/bodymritools/blob/main/misctools/CreateCustomSchemeFile.py): a tool _**creating a simple scheme file for SANDI fitting of a diffusion MRI scan featuring a single diffusion time, given the list of b-values**_. Manual [here](https://github.com/fragrussu/bodymritools/blob/main/manuals/CreateCustomSchemeFile.md).
* [**pgse2sphmean.py**](https://github.com/fragrussu/bodymritools/blob/main/misctools/pgse2sphmean.py): a tool _**computing the spherical mean of the diffusion signal for a pulsed-gradient spin echo (PGSE) experiment**_. The tool computed the mean over all available gradient directions acquired at fixed b-value $b$, gradient duration $\delta$ and gradient separation $\Delta$. Manual [here](https://github.com/fragrussu/bodymritools/blob/main/manuals/pgse2sphmean.md).
