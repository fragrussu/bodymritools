...
* [**pgse2sphmean.py**](https://github.com/fragrussu/bodymritools/blob/main/misctools/pgse2sphmean.py): a tool _**computing the spherical mean of the diffusion signal for a pulsed-gradient spin echo (PGSE) experiment**. The tool computed the mean over all available gradient directions acquired at fixed b-value $b$, gradient duration $\delta$ and gradient separation $\Delta$. Manual [here](https://github.com/fragrussu/bodymritools/blob/main/manuals/pgse2sphmean.md).
